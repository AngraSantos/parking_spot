package com.parking_spot.model;
...
public class ParkingSpotModel implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO) //gerador de ID de forma automática, não sequencial
	private UUID id;
	
	//-----------------------------------------------------------------------------------------------
	
	@Column(nullable = false, unique = true, length = 10)
	private String parkingSpotNumber; 		//Código da Vaga 
	...
	private LocalDateTime resgistrationDate; 	//Data do resgistro
